 var falling_state1=false;  var div=document.getElementById('dog');
	var falling_state2=true;
...
call_freshiee();
	...
	function letter_writing(){   //function for letter writing
	 ...
	 $('#letter').animate({opacity:'0.7'},1000);
	 $('.fire').fadeIn(3000);
    ...
    var doStep = function doStep() {
		...
		$('#revenue').animate({opacity:1},2000).animate({top:'30%',left:'70%'},3000,sosse);
function sosse()
	{
	
	$('#move').animate({opacity:'1'},1500).animate({top:'35%',left:'50%',width:'20%',height:'40%'},2000,chare).animate({opacity:'0'},1000,chop);
	}
	function chare()
	{
	document.getElementById('dog').style.display='none';
	document.getElementById('gunstringer').style.display='block';
	}
	
function chop()
{
	$('#part2').animate({opacity:0},3000,qweg); function qweg(){document.getElementById('part2').remove();}
			$('#part3').animate({opacity:1},2000,run);
			}
